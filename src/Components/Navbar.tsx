...
const Navbar = () => {
  ...
  return (
    <div className='fixed left-0 top-0 w-64 h-full bg-customGray p-4 font-inter'>
        ...
        <ul className="mt-4">
            ...
            <li className="mb-2">
            <Link to="/" className="flex items-center text-gray-300 py-2 px-4 hover:bg-gray-950 hover:text-gray-100  rounded-full">
