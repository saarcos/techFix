...
import { faTools, faBox, faWarehouse, faGear, faChevronDown, faHouseChimney, faPersonDigging, faPeopleGroup, faLayerGroup, faHandsHelping, faBoxesStacked, faBriefcase, faPlug } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className={`fixed left-0 top-0 w-64 h-full bg-customGray p-4 font-inter transition-transform transform ${isVisible ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 z-50`}>
      ...
      <ul className="mt-4">
        ...
        <li className="mb-2">
          <Link to="/taller/almacenes" 
            className={`${getLinkClass("/taller/almacenes")}`}
            onClick={handleLinkClick}>
