...
import DeleteForm from '@/Components/forms/marcas/delete-marca-form';
...
export function DataTableRowActions({ row }: DataTableRowActionsProps) {
  ...
  const brandId = row.original.id_marca;
  return (
    <>
      <ResponsiveDialog
        isOpen={isEditOpen}
      ...
      >
        <MarcaForm brandId={brandId} setIsOpen={setIsEditOpen}  />
      </ResponsiveDialog>
      <ResponsiveDialog
        isOpen={isDeleteOpen}
      ...
      >
        <DeleteForm brandId={brandId} setIsOpen={setIsDeleteOpen} />
      </ResponsiveDialog>
      <DropdownMenu>
